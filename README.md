...
<p align="left">
    ...
    <br>
        2. Change the <a href="https://github.com/sandippshah/clonebot/blob/master/app.json#L7" target="_blank"> app.json </a> 'repository' URL to your fork URL.
    <br>
        3. Change the <a href="https://github.com/sandippshah/clonebot/blob/master/README.md?plain=1#L25" target="_blank"> deploy button </a> URL to your fork URL.
    <br>
    ...
    <br><br>
      <a href="https://heroku.com/deploy?template=https://github.com/sandippshah/clonebot" target="_blank">
